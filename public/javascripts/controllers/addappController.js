...
app.controller('addappController', ['$scope', '$location', '$http', function($scope, $location, $http) {

    $scope.formData = {};
    $scope.formData.name = '';
    $scope.formData.countryName = '';
    ...
    $scope.addApp = function(){
        ...
        getCode( $scope.formData.countryName, function(code) {
            if (code) {
                $scope.formData.countryCode = code;
                $http.post('/addapp', $scope.formData)
